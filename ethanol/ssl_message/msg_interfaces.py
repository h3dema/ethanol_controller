...
from pox.ethanol.ssl_message.msg_common import MSG_TYPE, VERSION, send_and_receive_msg
...
def __get_intf(server, id=0, intf_name=[], sta_ip=None, sta_port=0, m_type=None):
  """
...
def get_one_intf(server, id=0, intf_name=None, sta_ip=None, sta_port=0):
  """ MSG_GET_ONE_INTF: eturns info of interface "intf_name" 
    ...
    @return: msg - received message
  """
  return __get_intf(server=server, id=id, intf_name=intf_name, 
                sta_ip=sta_ip, sta_port=sta_port, m_type=MSG_TYPE.MSG_GET_ONE_INTF)

def get_interfaces(server, id=0, sta_ip=None, sta_port=0):
  """ MSG_GET_ALL_INTF: returns all interfaces 
    ...
    @return: msg - received message
  """
  return __get_intf(server=server, id=id, intf_name=[], 
