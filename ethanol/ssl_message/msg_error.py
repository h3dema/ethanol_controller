...
from pox.ethanol.ssl_message.msg_common import MSG_TYPE, MSG_ERROR_TYPE, MSG_ERROR_TYPE
...
def get_error_msg(received_msg):
  if is_error_msg(received_msg): return None
  msg = msg_error.parse(received_msg)
  return msg

def return_error_msg_struct(id, error_type = MSG_ERROR_TYPE.ERROR_UNKNOWN):
  """
...
def process_msg_not_implemented(received_msg, fromaddr):
  ...
  return return_error_msg_struct(id, MSG_ERROR_TYPE.ERROR_PROCESS_NOT_IMPLEMENTED_FOR_THIS_MESSAGE)
