...
def send_msg_mean_sta_statistics_interface_add(server, id=0, sta_ip=None, sta_port=0, intf_name=None):
  ...
  send_and_receive_msg(server, msg_struct, msg_mean_sta_statistics_interface.build, msg_mean_sta_statistics_interface.parse, only_send=True)
...
def send_msg_mean_sta_statistics_alpha(server, id=0, sta_ip=None, sta_port=0, alpha=0.1):
  ...
  ssend_and_receive_msg(server, msg_struct, msg_mean_sta_statistics_alpha.build, msg_mean_sta_statistics_alpha.parse, only_send=True)
...
def send_msg_mean_sta_statistics_time(server, id=0, sta_ip=None, sta_port=0, msec=100):
  ...
  ssend_and_receive_msg(server, msg_struct, msg_mean_sta_statistics_time.build, msg_mean_sta_statistics_time.parse, only_send=True)
