...
from pox.ethanol.ssl_message.msg_core   import msg_default, decode_default_fields, field_intf_name, field_station, field_mac_addr
...
def set_snr_threshold(server, id=0, sta_ip=None, sta_port = 0, sta_mac=None, intf_name=None, mac_ap=None):
  ...
  error, msg = send_and_receive_msg(server, msg_struct, msg_snr_threshold_reached.build, msg_snr_threshold_reached.parse)
  if not error:
    pass
  return msg
...
def process_snr_threshold(receivedmsg, fromaddr):
  ...
  events_snr_threshold_reached.on_change(msg=msg, fromaddr=fromaddr, sta_mac=sta_mac, intf_name=intf_name, mac_ap=mac_ap)
...
def snr_threshold_interval_reached(server, id=0, sta_ip=None, sta_port = 0, intf_name=None, interval=10):
  ...
  send_and_receive_msg(server, msg_struct, msg_snr_threshold_reached.build, msg_snr_threshold_reached.parse, only_send=True)
